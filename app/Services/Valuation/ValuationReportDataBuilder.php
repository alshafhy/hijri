...
final class ValuationReportDataBuilder
{
    ...
    public function build(ValuationRequest $request, ReportExportVariant $variant): array
    {
        ...
        return [
            ...
            'facade' => $facade,
            'service' => $service,
            'components' => $property?->components ?? collect(),
            'comparables' => $property?->comparables ?? collect(),
            'adjustments' => $property?->adjustments ?? collect(),
            'totals' => $totals,
            ...
            'hide_comparisons' => (bool) ($totals['property_total']?->hide_comparisons_info_table ?? false),
            'hide_evaluation' => (bool) ($totals['property_total']?->hide_evaluation_info_table ?? false),
