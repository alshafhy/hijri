...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
        |--------------------------------------------------------------------------
        | Legacy (read-only) connection — Phase 7 importers
        |--------------------------------------------------------------------------
        |
        | Points at the old muqaym database. Importers must never write here.
        | Host/user/password fall back to the primary DB_* values when unset.
        |
        */
        'legacy' => [
            'driver' => 'mysql',
            ...
            'database' => env('LEGACY_DB_DATABASE', 'muqaym'),
